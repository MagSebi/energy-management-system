...
public class SyncPublisher {
    ...
    public void publishUserCreated(UUID userId, String username, String name, String address, Integer age) {
        ...
        try {
            ...
            logger.info("Published USER_CREATED event for user: {} with Person data", userId);
        } catch (Exception e) {
    ...
    public void publishUserUpdated(UUID userId, String username, String name, String address, Integer age) {
        ...
        try {
            rabbitTemplate.convertAndSend(syncExchange, syncUserRoutingKey, message);
            logger.info("Published USER_UPDATED event for user: {} with Person data", userId);
        } catch (Exception e) {
